...
The evolution of sexual reproduction still remains largely unsolved [CITE].
...
The most often cited is perhaps the cost of producing males \citep{smith1978evolution}.
...
hence, cost of sex is often referred to as the infamous \emph{two-fold cost of sex} \citep{smith1978evolution}.
