...
While it is a common practice to assume parameters of a Red Queen model \swp{CITE}, making strong parametric assumptions can lead to overly confident conclusions \citep{elderd2006uncertainty}.
...
Distance is measured by the sum of absolute differences in summary statistics between simulated and observed data. \swp{REF?}
