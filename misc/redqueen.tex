...
Then, we fit the model to observational data from three field studies \citep{dagan2013clonal, mckone2016fine, vergara2014infection} using Approximate Bayesian Computation (ABC) to estimate biologically relevant parameters.
...
Their habitats are subject to seasonal flash floods, which can affect reproductive strategies of snails \citep{ben2007temporal} and interfere with the host-parasite coevolution \swp{CITE}.
...
Although exact genetic architecture that determines trematode infecion in snails (e.g., the number and inheritence of loci involved in parasite resistance) is not known, the documented genetic diversity of snails is far greater than what we have assumed \citep{king2011parasites, dagan2013clonal}.
...
This work was supported by The Natural Sciences and Engineering Research Council, Undergraduate Student Research Award (to SWP).
