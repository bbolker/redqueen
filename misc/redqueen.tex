...
Note that \fref{ivs} appears to be more variable than \fref{smcsumm} as it plots density of all simulated populations whereas the latter plots summary statistics computed across the population.
...
but our model predicts sexual reproduction to be maintained when infection prevalence is relatively higher. 
