...
\end{aligned}
\end{equation}
The expected number of infected hosts that have genotype $ij$ and are infected by parasites with genotype $i$ in the next generation is proportional to amount of infectious contacts that was made in the current generation:
\begin{equation}
\begin{aligned}
