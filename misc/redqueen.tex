...
However, simple models can still be used to make qualitatively useful predictions about the nature.
...
Even though we do not obtain good fits to data from \cite{dagan2013clonal} and \cite{mckone2016fine}, we find that high virulence and low asexual to sexual genetic diversity is necesary to partially explain the observed data.
