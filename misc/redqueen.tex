...
Using estimated parameters for each data, we calculate the power to detect positive correlation between infection prevalence and frequency of sexual hosts.
