...
While there are a few outliers based on our fits to \cite{vergara2014infection},
...
The observed data are more likely to be slices across a few generations and cyclic nature of the Red Queen dynamics creates more variation in the data, which is not captured in \fref{ivs}.

[TODO: Talk about a weird sites]

Based on goodness of fits, we exclude fits to \cite{dagan2013clonal} and \cite{mckone2016fine} from discussing parameter estimates and power analysis.
