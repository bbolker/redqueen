...
In particular, there was a clear mismatch between the model prediction and the data presented by \cite{dagan2013clonal} (\fref{ivs}).
...
On the other hand, discrepancy between 
