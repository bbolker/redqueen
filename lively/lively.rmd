...
vergara2013a %>% as.tbl %>% group_by(year, lake, sites, habitat) %>% summarize(psex=mean(sex=="male"), pinf=mean(as.numeric(as.character(Microphallus)), na.rm=TRUE)) -> vv
```
