...
Since we plot the \emph{predicted} densities, they are able to capture the full range of coevolutionary dynamics, which may not be fully represented in the observed data; 
therefore, studying the shape of these densities can help us better understand how the Red Queen dynamics shape the relationship between the proportion of infected and sexual hosts.
...
\rev{please go into more detail. How does this figure relate to the studies? I am very confused.}
...
\rev{a citation and more detail are required for such a bold statement.}
...
\rev{how do these environmental circumstances influence the potential for coevolution?}
