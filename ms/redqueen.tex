...
It is unclear how well these models capture the coevolutionary dynamics observed in nature.
...
Here, we try to test whether a simple model can capture the 
coevolutionary dynamics observed in real data.
...
The current parameter set is accepted if the sum of absoluate differences between the simulated summary statistics and the observed summary statistics is less than a pre-specified tolerance value (i.e., acceptable amount of difference between the model and the data).
...
If a proposed parameter is accepted (i.e., the sum of absolaute difference between the simulated summary statistics and the observed summary statistics is less than a tolerance value), the following weight is assigned to the parameter set:
$$
