...
\caption{The snail population in a New Zealand lake \cite{mckone2016fine} supports Lively's \cite{lively2001trematode} prediction of positive correlation between proportion \mars,  representing proportion of sexual snails, and
parasite prevalence.}
\end{figure}
\end{center}
\vspace{-1em}
